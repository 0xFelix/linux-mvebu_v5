...
license=('GPL2')
makedepends=('xmlto' 'docbook-xsl' 'uboot-tools' 'kmod' 'inetutils' 'bc' 'git')
options=('!strip')
...
_package-headers() {
  ...
  conflicts=('linux-kirkwood-headers' 'linux-headers-kirkwood-dt' 'linux-headers' 'linux-headers-olinuxino')
  replaces=('linux-headers-mvebu_v5')
